...
public class TaskEvaluator extends OperatorChain {
	...
	public TaskEvaluator(OperatorDescription description) {
		this(description, "Nested Chain");
	}

	/** This constructor allows subclasses to change the subprocess' name. */
	protected TaskEvaluator(OperatorDescription description, String subProcessName) {
	...
	public void doWork() throws OperatorException {
		...
		Configurator.out("delivered "+inputExtender.getManagedPairs().size()+"managed inputs");
